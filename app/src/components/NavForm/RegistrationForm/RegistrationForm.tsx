...
import { postUser, signIn } from "../../../services/userRequests";
import {
  blurHandler,
  passwordHandler,
  emailHandler,
...
const RegistrationForm: React.FunctionComponent<IRegistration> = ({
  updateState,
  updateEnter,
  updateSwitchButton
}) => {
  ...
  document
    ...
    ?.addEventListener("click", () => setRegistrationError(false));
