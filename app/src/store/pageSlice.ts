...
export const slice = createSlice({
  ...
  reducers: {
    ...
    cleanMarkedWords: (state) => {state.markedWordsOnPage = []}
  }
})
export const { setGroup, setPage, setMarkedWords, addMarkedWords, removeMarkedWords, cleanMarkedWords} = slice.actions;
