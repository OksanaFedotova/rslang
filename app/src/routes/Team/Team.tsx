      ...
      <div className="team-wrapper">
        <div className="team-member">
          ...
          <p className="team-member-decription">
            Реализовала структуру приложения, создала раздел Учебник, настроила
            бекенд, реализовала весь обмен данными с сервером
          </p>
          <a
            target="blank"
            rel="noreferer"
        ...
        <div className="team-member">
          ...
          <p className="team-member-decription">
            Разработал игру Аудиовызов, создал форму регистрации
          </p>
          <a
            target="blank"
            rel="noreferer"
            href="https://github.com/sashajozwiak"
            className="github-link"
          >
            <img src={githubIcon} alt={"github-image"} />
          </a>
        ...
        <div className="team-member">
          ...
          <p className="team-member-role">Developer</p>
          <p className="team-member-decription">
            Разработала игру Спринт, создала бургер-меню, занималась оформлением
            приложения
          </p>
          <a
            target="blank"
